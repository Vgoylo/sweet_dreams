...
class Dream < ApplicationRecord
  ...
  after_create_commit :dream_saved_to_db
  after_update_commit :dream_saved_to_db
  ...
  def destroy_action
    puts 'Dream was success deleted'
  end

  def dream_saved_to_db
    puts 'Dream was success save to database'
  end
